...
//    UIView *MyView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, ScreenWidth, 220)];
    __weak typeof (self)weakSelf = self;
    UIView *MyView = [[UIView alloc] init];
//    MyView.backgroundColor = [UIColor colorWithRed:(170)/255.f green:(170)/255.f blue:(170)/255.f alpha:1.f];
...
//         make.bottom.equalTo(weakSelf.view).offset(200);
         make.height.mas_equalTo(ScreenHeight-64-123*3);
//         make.width.mas_equalTo(ScreenWidth);
    ...
    myScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, ScreenHeight-123*3-64, ScreenWidth, 123*3)];
